...
Modified: 2015-11-18 08:58:17
Filename: .update.sh
'

# This script should be ran from a crontab or similar utility to be ran every 5-10 minutes

# This script checks the file's mod date against what the system has and changes it automatically
...
do
    # grabs the system's mod date through the stat command and gets the file's internal mod date 
    # and stores them
